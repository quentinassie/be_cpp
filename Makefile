main : main.cpp Aquarium.o Bestiole.o Milieu.o BestioleFactory.o gregaire.o
	g++ -Wall -std=c++11 -o main main.cpp Aquarium.o Bestiole.o Milieu.o BestioleFactory.o gregaire.o -I . -lX11 -lpthread
